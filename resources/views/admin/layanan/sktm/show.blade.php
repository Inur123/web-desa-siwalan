...
@section('content')
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            @if ($sktm->status === 'baru')
                <form action="{{ route('admin.sktm.updateStatus', $sktm->uuid) }}" method="POST" class="mt-6" id="statusForm">
                    @csrf
                    @method('PATCH')
