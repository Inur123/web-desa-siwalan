...
<body>
    ...
    <div class="nomor-surat">
        ...
        <p style="text-decoration: underline;">Nomor : 140/ /405.29.08.05/2026</p>
    </div>

    <!-- ISI SURAT -->
    <div class="isi-surat">
        <p>
            Yang bertanda tangan di bawah ini Kepala Desa Siwalan Kecamatan Mlarak Kabupaten Ponorogo menerangkan bahwa :
        </p>
    </div>
    ...
    <div class="data-pemohon">
        <table>
            <tr>
                <td>Nama</td>
                <td>:</td>
                <td><strong>{{ strtoupper($suratKeteranganDomisili->nama) }}</strong></td>
            </tr>
            <tr>
                <td>Tempat Tanggal Lahir</td>
                <td>:</td>
                <td>{{ $suratKeteranganDomisili->tempat_lahir }}, {{ \Carbon\Carbon::parse($suratKeteranganDomisili->ttl)->isoFormat('D MMMM Y') }}</td>
            </tr>
            @if ($suratKeteranganDomisili->jenis_kelamin)
                <tr>
                    <td>Jenis Kelamin</td>
                    <td>:</td>
                    <td>{{ $suratKeteranganDomisili->jenis_kelamin }}</td>
                </tr>
            @endif
            @if ($suratKeteranganDomisili->kewarganegaraan)
                <tr>
                    ...
                    <td>:</td>
                    <td>{{ $suratKeteranganDomisili->kewarganegaraan }}</td>
                </tr>
            @endif
            @if ($suratKeteranganDomisili->pekerjaan)
                <tr>
                    <td>Pekerjaan</td>
                    <td>:</td>
                    <td>{{ $suratKeteranganDomisili->pekerjaan }}</td>
                </tr>
            @endif
            @if ($suratKeteranganDomisili->status_perkawinan)
                <tr>
                    ...
                    <td>:</td>
                    <td>{{ $suratKeteranganDomisili->status_perkawinan }}</td>
                </tr>
            @endif
            <tr>
                <td>Nomor KTP / NIK</td>
            ...
            @if ($suratKeteranganDomisili->agama)
                <tr>
                    <td>Agama</td>
                    <td>:</td>
                    <td>{{ $suratKeteranganDomisili->agama }}</td>
                </tr>
            @endif
            <tr>
                <td>Alamat</td>
    ...
    <div class="isi-surat">
        <p style="margin-top:8px;">
            Menerangkan bahwa orang tersebut di atas sampai sekarang masih berdomisili di
            @if($suratKeteranganDomisili->rt) RT {{ $suratKeteranganDomisili->rt }} @endif
            @if($suratKeteranganDomisili->rw) RW {{ $suratKeteranganDomisili->rw }} @endif
            @if($suratKeteranganDomisili->dukuh) Dukuh {{ $suratKeteranganDomisili->dukuh }} @endif
            Desa Siwalan Kecamatan Mlarak Kabupaten Ponorogo sejak Tahun {{ $suratKeteranganDomisili->tahun_domisili ?? '____' }}
        </p>
        <p style="margin-top:8px;">
    ...
    <div class="ttd-wrap">
        <table class="ttd-table">
            <tr>
                <!-- Kolom kiri dikosongkan supaya posisi Kades tetap di kanan -->
                <td class="ttd-col">
                    &nbsp;
                </td>
                ...
                <td class="ttd-col">
                    <div class="ttd-box">
                        <p class="ttd-top">
                            <strong>Siwalan, {{ \Carbon\Carbon::now()->isoFormat('D MMMM Y') }}</strong>
                        </p>
                         <p class="ttd-top">Mengetahui</p>
