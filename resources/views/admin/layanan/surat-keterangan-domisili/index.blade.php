...
@section('title', 'Daftar Pengajuan Surat Keterangan Domisili - Admin')

@section('content')
    <div class="max-w-7xl mx-auto">

        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Pengajuan Surat Keterangan Domisili</h1>
            <p class="text-gray-600">Kelola pengajuan Surat Keterangan Domisili dari masyarakat</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Alamat
                        </th>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    @forelse($suratDomisilis as $index => $item)
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 text-sm text-gray-700 font-medium">{{ $suratDomisilis->firstItem() + $index }}</td>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-700">
                                {{ \Illuminate\Support\Str::limit($item->alamat, 30) }}</td>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center items-center gap-2">
                                    <a href="{{ route('admin.surat-keterangan-domisili.show', $item->uuid) }}"
                                    ...
                                    <form action="{{ route('admin.surat-keterangan-domisili.destroy', $item->uuid) }}" method="POST"
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center text-gray-400">
                                    ...
                                    <p class="text-lg font-medium">Belum ada pengajuan Surat Keterangan Domisili</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
            ...
            @if ($suratDomisilis->hasPages())
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                    {{ $suratDomisilis->links() }}
                </div>
            @endif
        </div>
    </div>
