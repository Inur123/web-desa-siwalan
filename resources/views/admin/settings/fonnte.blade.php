        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <ul class="text-sm text-blue-800 space-y-1">
                    ...
                    <li>• Token bisa didapatkan dari <a href="https://fonnte.com" target="_blank"
                            class="underline font-semibold">fonnte.com</a></li>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="fonnte_token"
                                value="{{ old('fonnte_token', $settings['fonnte_token'] ?? '') }}" required
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="fonnte_admin_phone"
                                value="{{ old('fonnte_admin_phone', $settings['fonnte_admin_phone'] ?? '') }}" required
                            ...
                            <p class="text-xs text-gray-500 mt-1">
                                <i class="fab fa-whatsapp"></i> Nomor ini akan menerima notifikasi setiap ada pengajuan
                                layanan baru dari warga
                            </p>
