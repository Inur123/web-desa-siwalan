...
@section('title', 'Pengaturan Template Surat')
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            @if ($settings['logo_kop_surat'] ?? null)
                                <div class="mb-3">
                                    <img src="{{ asset('storage/' . $settings['logo_kop_surat']) }}" alt="Logo"
                            ...
                            <p class="text-xs text-gray-500 mt-1">Format: PNG (transparan recommended), JPG, JPEG. Max 1MB.
                            </p>
                            <p class="text-xs text-blue-600 mt-1"><i class="fas fa-info-circle"></i> Ukuran optimal:
                                200x200px atau 300x300px untuk hasil terbaik</p>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <input type="text" name="kop_surat_kabupaten"
                                    value="{{ old('kop_surat_kabupaten', $settings['kop_surat_kabupaten'] ?? '') }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="kop_surat_kecamatan"
                                    value="{{ old('kop_surat_kecamatan', $settings['kop_surat_kecamatan'] ?? '') }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="kop_surat_desa"
                                    value="{{ old('kop_surat_desa', $settings['kop_surat_desa'] ?? '') }}" required
                                    placeholder="DESA ..."
                            ...
                            <div>
                                ...
                                <input type="text" name="kop_surat_alamat"
                                    value="{{ old('kop_surat_alamat', $settings['kop_surat_alamat'] ?? '') }}" required
                                    placeholder="Jl. ..."
                            ...
                            <div>
                                ...
                                <input type="text" name="kop_surat_kontak"
                                    value="{{ old('kop_surat_kontak', $settings['kop_surat_kontak'] ?? '') }}" required
                                    placeholder="Email: ... | Telp: ..."
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="nama_kepala_desa"
                                    value="{{ old('nama_kepala_desa', $settings['nama_kepala_desa'] ?? '') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="nip_kepala_desa"
                                    value="{{ old('nip_kepala_desa', $settings['nip_kepala_desa'] ?? '') }}" required
                                    placeholder="NIP"
