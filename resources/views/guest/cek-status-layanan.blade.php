            ...
            <form action="{{ route('guest.cek-status-layanan.check') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="kode_layanan" value="{{ old('kode_layanan', $kode) }}"
                        placeholder="Contoh: SKTM-20260112-ABCDE, SKH-20260112-ABCDE, atau SKD-20260112-ABCDE"
        ...
        @if ($data)
            ...
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    @else
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        <p class="text-gray-600 font-semibold">Alamat Domisili</p>
                        <p class="text-gray-900 font-bold">{{ $data->alamat }}</p>
                    </div>
                    @endif
                </div>
