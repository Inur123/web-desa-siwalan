...
@section('content')
    <main class="max-w-7xl mx-auto px-4 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <!-- Service 4: Surat Keterangan Domisili -->
            <a href="{{ route('guest.surat-keterangan-domisili') }}" class="service-card bg-white border border-gray-200 rounded-xl p-8 shadow-sm hover:shadow-lg">
                <div class="text-5xl mb-4 text-blue-600"><i class="fas fa-home"></i></div>
                <h3 class="text-2xl font-bold text-gray-900 mb-3">Surat Keterangan Domisili</h3>
                <p class="text-gray-600 mb-6">Pengurusan surat keterangan domisili untuk berbagai keperluan administrasi dan legalitas tempat tinggal.</p>
                <div class="space-y-2 text-sm text-gray-700">
                    <p>• Keperluan KTP</p>
                    <p>• Keperluan Sekolah</p>
                    <p>• Keperluan Usaha</p>
                </div>
                <div class="mt-6 text-green-600 font-semibold hover:text-green-700">
                    Buka Layanan →
